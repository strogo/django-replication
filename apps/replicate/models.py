...
class Host(models.Model):
	name = models.CharField(max_length = 32, verbose_name = _(u"name"), help_text = _(u"A name to identify this host."))
...
class Database(models.Model):
	...
	backend = models.CharField(max_length = 16, choices = BACKEND_CHOICES, verbose_name = _(u"backend"), help_text = _(u"Database driver to be used"))
	name = models.CharField(max_length = 32, help_text = _(u"Name of the database (or ORACLE database service name)"), verbose_name = _(u"name"))
	#TODO: string to dict()
	options = models.TextField(blank = True, null = True, verbose_name = _(u"options"))
	username = models.CharField(max_length = 32, blank = True, null = True, verbose_name = _(u"username"), help_text = _(u"The username that will be used to connect to this database"))
	password = models.CharField(max_length = 64, blank = True, null = True, verbose_name = _(u"password"), help_text = _(u"Password of the user that will be used to connect to the database"))
	port = models.CharField(max_length = 8, blank = True, null = True, verbose_name = _(u"port"), help_text = _(u"The port used to connect to the database, leave blank for default port number"))
...
class Conduit_Set(models.Model):
	...
	concurrent = models.BooleanField(default = False, help_text = _(u"If true, allows the conduits contained within to execute at the same time else sequencially."), verbose_name = _(u"concurrent"))
